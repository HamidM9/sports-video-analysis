...
int im13() {
    ...
    Scalar lowerField(63, 144, 62);
    Scalar upperField(85, 255, 155);
    Scalar lowerTeamAShirt(80, 0, 247);
    Scalar upperTeamAShirt(149, 14, 255);
    Scalar lowerTeamAShort(7, 172, 124);
    Scalar upperTeamAShort(12, 255, 255);
    Scalar lowerTeamASocks(7, 172, 124);
    Scalar upperTeamASocks(12, 255, 255);
    Scalar lowerTeamBShirt(0, 178, 180);
    Scalar upperTeamBShirt(4, 255, 255);
    Scalar lowerTeamBShort(90, 70, 0);
    Scalar upperTeamBShort(135, 121, 100);
    Scalar lowerTeamBSocks(90, 70, 0);
    Scalar upperTeamBSocks(135, 121, 100);
    ...
    Canny(cannyEdgesBeforeSegment, cannyEdgesBeforeSegment, 0, 255);

...
int im9() {
    ...
    std::string imagePath = "Images/im09.jpg";  // Path to your image
    ...
    Scalar lowerField(0, 0, 180);
    Scalar upperField(180, 17, 255);
    Scalar lowerTeamAShirt(0, 195, 180);
    Scalar upperTeamAShirt(27, 255, 255);
    Scalar lowerTeamAShort(112, 145, 0);
    Scalar upperTeamAShort(125, 220, 255);
    Scalar lowerTeamASocks(0, 195, 180);
    Scalar upperTeamASocks(27, 255, 255);
    Scalar lowerTeamBShirt(170, 165, 0);
    Scalar upperTeamBShirt(180, 255, 255);
    Scalar lowerTeamBShort(0, 0, 0);
    Scalar upperTeamBShort(110, 255, 55);
    Scalar lowerTeamBSocks(170, 165, 0);
    Scalar upperTeamBSocks(180, 255, 255);
    ...
    Canny(cannyEdgesBeforeSegment, cannyEdgesBeforeSegment, 0, 140);
    ...
    overlaidImage.setTo(Scalar(0, 255, 0), cannyEdgesBeforeSegment);
    ...
    overlaidImageSeg.setTo(Scalar(0, 255, 0), cannyEdgesBeforeSegment);

...
int im7() {
    ...
    std::string imagePath = "Images/im7.jpg";  // Path to your image
    ...
    Scalar lowerField(25, 25, 0);
    Scalar upperField(60, 255, 235);
    Scalar lowerTeamAShirt(60, 78, 76);
    Scalar upperTeamAShirt(76, 255, 255);
    Scalar lowerTeamAShort(0, 0, 175);
    Scalar upperTeamAShort(105, 30, 255);
    Scalar lowerTeamASocks(60, 78, 76);
    Scalar upperTeamASocks(76, 255, 255);
    Scalar lowerTeamBShirt(92, 0, 0);
    Scalar upperTeamBShirt(180, 130, 70);
    Scalar lowerTeamBShort(92, 0, 0);
    Scalar upperTeamBShort(180, 130, 70);
    Scalar lowerTeamBSocks(0, 0, 175);
    Scalar upperTeamBSocks(105, 30, 255);
    ...
    Canny(cannyEdgesBeforeSegment, cannyEdgesBeforeSegment, 90, 200);
    ...
    Canny(cannyEdgesAfterSegment, cannyEdgesAfterSegment, 0, 0);
    ...
    std::string cannyEdgesBeforeSegmentPath = resultDirName + "/cannyEdgesBeforeSegment.jpg";
    cv::imwrite(cannyEdgesBeforeSegmentPath, cannyEdgesBeforeSegment);
    ...
    Canny(cannyEdgesplayersOnly, cannyEdgesplayersOnly, 30, 110);

    // Show the Canny edges of the players only image
    namedWindow("Canny Edges of Players Only Image", WINDOW_NORMAL);
    imshow("Canny Edges of Players Only Image", cannyEdgesplayersOnly);
    std::string cannyEdgesplayersOnlyPath = resultDirName + "/cannyEdgesplayersOnly.jpg";
    cv::imwrite(cannyEdgesplayersOnlyPath, cannyEdgesplayersOnly);

    // Overlay merged Canny edges on the original image
    Mat overlaidImage = image.clone();
    overlaidImage.setTo(Scalar(0, 255, 0), cannyEdgesplayersOnly);
    ...
    overlaidImageSeg.setTo(Scalar(0, 255, 0), cannyEdgesplayersOnly);
    ...
    morphologyEx(cannyEdgesAfterSegment, cannyEdgesAfterSegment, MORPH_CLOSE, morphKernel);

    // Find contours in the connected edge map
    std::vector<std::vector<Point>> contours;
    std::vector<Vec4i> hierarchy;
    findContours(cannyEdgesAfterSegment, contours, hierarchy, RETR_EXTERNAL, CHAIN_APPROX_SIMPLE);

...
int im6() {
    ...
    std::string imagePath = "Images/im6.jpg";  // Path to your image
    ...
    Scalar lowerTeamAShirt(0, 0, 165);
    Scalar upperTeamAShirt(180, 30, 255);
    Scalar lowerTeamAShort(0, 0, 165);
    Scalar upperTeamAShort(180, 30, 255);
    Scalar lowerTeamASocks(0, 0, 0);
    Scalar upperTeamASocks(180, 255, 75);
    Scalar lowerTeamBShirt(0, 0, 0);
    Scalar upperTeamBShirt(180, 255, 75);
    Scalar lowerTeamBShort(0, 0, 0);
    Scalar upperTeamBShort(180, 255, 75);
    Scalar lowerTeamBSocks(0, 0, 0);
    Scalar upperTeamBSocks(180, 255, 75);

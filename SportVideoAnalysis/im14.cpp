...
int im14() {
    ...
    std::string imagePath = "Images/im14.jpg";  // Path to your image
    ...
    Scalar lowerField(0, 0, 232);
    Scalar upperField(180, 255, 255);
    Scalar lowerTeamAShirt(114, 5, 199);
    Scalar upperTeamAShirt(154, 29, 230);
    Scalar lowerTeamAShort(104, 62, 0);
    Scalar upperTeamAShort(123, 143, 33);
    Scalar lowerTeamASocks(104, 62, 0);
    Scalar upperTeamASocks(123, 143, 33);
    Scalar lowerTeamBShirt(0, 94, 29);
    Scalar upperTeamBShirt(119, 255, 90);
    Scalar lowerTeamBShort(0, 94, 29);
    Scalar upperTeamBShort(119, 255, 90);
    Scalar lowerTeamBSocks(0, 94, 29);
    Scalar upperTeamBSocks(119, 255, 90);
    ...
    SegmentedTeamA.setTo(Scalar(0, 0, 0), ~teamAMask); // Invert the mask to zero out the non-teamA region
    ...
    SegmentedTeamB.setTo(Scalar(0, 0, 0), ~teamBMask); // Invert the mask to zero out the non-teamB region
    ...
    Canny(cannyEdgesBeforeSegment, cannyEdgesBeforeSegment, 0, 49);
    ...
    Canny(cannyEdgesAfterSegment, cannyEdgesAfterSegment, 85, 101);

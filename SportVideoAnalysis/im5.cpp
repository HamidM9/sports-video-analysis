...
int im5() {
    ...
    std::string imagePath = "Images/im5.jpg";  // Path to your image
    ...
    Scalar lowerField(15, 53, 143);
    Scalar upperField(180, 180, 255);
    Scalar lowerTeamAShirt(0, 0, 12);
    Scalar upperTeamAShirt(30, 75, 45);
    Scalar lowerTeamAShort(0, 0, 12);
    Scalar upperTeamAShort(30, 75, 45);
    Scalar lowerTeamASocks(0, 0, 12);
    Scalar upperTeamASocks(30, 75, 45);
    Scalar lowerTeamBShirt(0, 0, 195);
    Scalar upperTeamBShirt(180, 35, 255);
    Scalar lowerTeamBShort(0, 0, 195);
    Scalar upperTeamBShort(180, 35, 255);
    Scalar lowerTeamBSocks(0, 0, 195);
    Scalar upperTeamBSocks(180, 35, 255);

...
int im4() {
    ...
    std::string imagePath = "Images/im4.jpg";  // Path to your image
    ...
    Scalar lowerField(40, 56, 23);
    Scalar upperField(81, 255, 255);
    Scalar lowerTeamAShirt(0, 0, 200);
    Scalar upperTeamAShirt(180, 5, 255);
    Scalar lowerTeamAShort(90, 87, 73);
    Scalar upperTeamAShort(107, 223, 217);
    Scalar lowerTeamASocks(66, 0, 189);
    Scalar upperTeamASocks(93, 255, 255);
    Scalar lowerTeamBShirt(108, 115, 18);
    Scalar upperTeamBShirt(119, 255, 255);
    Scalar lowerTeamBShort(0, 0, 0);
    Scalar upperTeamBShort(180, 255, 15);
    Scalar lowerTeamBSocks(51, 44, 27);
    Scalar upperTeamBSocks(81, 85, 100);

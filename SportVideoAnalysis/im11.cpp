...
int im11() {
    ...
    std::string imagePath = "Images/im11.jpg";  // Path to your image
    ...
    Scalar lowerField(96, 32, 134);
    Scalar upperField(136, 79, 183);
    Scalar lowerTeamAShirt(0, 0, 0);
    Scalar upperTeamAShirt(180, 188, 19);
    Scalar lowerTeamAShort(0, 0, 0);
    Scalar upperTeamAShort(180, 188, 19);
    Scalar lowerTeamASocks(0, 0, 0);
    Scalar upperTeamASocks(180, 188, 19);
    Scalar lowerTeamBShirt(0, 12, 179);
    Scalar upperTeamBShirt(24, 95, 255);
    Scalar lowerTeamBShort(135, 179, 44);
    Scalar upperTeamBShort(180, 255, 152);
    Scalar lowerTeamBSocks(0, 12, 179);
    Scalar upperTeamBSocks(24, 95, 255);
    ...
    Canny(cannyEdgesBeforeSegment, cannyEdgesBeforeSegment, 0, 29);

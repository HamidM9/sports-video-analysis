...
int im15() {
    ...
    Scalar lowerTeamAShirt(0, 0, 90);
    Scalar upperTeamAShirt(180, 30, 255);
    Scalar lowerTeamAShort(0, 0, 0);
    Scalar upperTeamAShort(180, 255, 55);
    Scalar lowerTeamASocks(0, 0, 90);
    Scalar upperTeamASocks(180, 30, 255);
    Scalar lowerTeamBShirt(95, 38, 50);
    Scalar upperTeamBShirt(140, 255, 255);
    Scalar lowerTeamBShort(95, 38, 50);
    Scalar upperTeamBShort(140, 255, 255);
    Scalar lowerTeamBSocks(95, 38, 50);
    Scalar upperTeamBSocks(140, 255, 255);
    ...
    Canny(cannyEdgesBeforeSegment, cannyEdgesBeforeSegment, 0, 143);

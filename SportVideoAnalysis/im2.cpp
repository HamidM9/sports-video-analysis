...
int im2() {
    ...
    std::string imagePath = "Images/im2.jpg";  // Path to your image
    ...
    Scalar lowerField(0, 0, 141);
    Scalar upperField(180, 170, 255);
    Scalar lowerTeamAShirt(15, 100, 115);
    Scalar upperTeamAShirt(50, 255, 255);
    Scalar lowerTeamAShort(95, 95, 0);
    Scalar upperTeamAShort(170, 255, 110);
    Scalar lowerTeamASocks(120, 15, 155);
    Scalar upperTeamASocks(145, 50, 255);
    Scalar lowerTeamBShirt(95, 95, 0);
    Scalar upperTeamBShirt(170, 255, 110);
    Scalar lowerTeamBShort(95, 95, 0);
    Scalar upperTeamBShort(170, 255, 110);
    Scalar lowerTeamBSocks(120, 15, 155);
    Scalar upperTeamBSocks(145, 50, 255);
    ...
    Canny(cannyEdgesAfterSegment, cannyEdgesAfterSegment, 0, 100);

...
int im3() {
    ...
    std::string imagePath = "Images/im3.jpg";  // Path to your image
    ...
    Scalar lowerField(0, 65, 180);
    Scalar upperField(7, 160, 255);
    Scalar lowerTeamAShirt(120, 0, 160);
    Scalar upperTeamAShirt(180, 100, 255);
    Scalar lowerTeamAShort(0, 0, 60);
    Scalar upperTeamAShort(12, 255, 157);
    Scalar lowerTeamASocks(120, 0, 160);
    Scalar upperTeamASocks(180, 100, 255);
    Scalar lowerTeamBShirt(110, 10, 0);
    Scalar upperTeamBShirt(180, 255, 80);
    Scalar lowerTeamBShort(110, 10, 0);
    Scalar upperTeamBShort(180, 255, 80);
    Scalar lowerTeamBSocks(120, 0, 160);
    Scalar upperTeamBSocks(180, 100, 255);
    ...
    Canny(cannyEdgesAfterSegment, cannyEdgesAfterSegment, 0, 101);

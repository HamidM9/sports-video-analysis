...
int im8() {
    ...
    std::string imagePath = "Images/im8.jpg";  // Path to your image
    ...
    Scalar lowerField(60, 0, 40);
    Scalar upperField(106, 255, 255);
    Scalar lowerTeamAShirt(107, 0, 172);
    Scalar upperTeamAShirt(180, 70, 255);
    Scalar lowerTeamAShort(0, 0, 0);
    Scalar upperTeamAShort(180, 255, 52);
    Scalar lowerTeamASocks(0, 0, 0);
    Scalar upperTeamASocks(180, 255, 52);
    Scalar lowerTeamBShirt(0, 155, 100);
    Scalar upperTeamBShirt(180, 255, 255);
    Scalar lowerTeamBShort(0, 0, 0);
    Scalar upperTeamBShort(180, 255, 52);
    Scalar lowerTeamBSocks(0, 0, 0);
    Scalar upperTeamBSocks(180, 255, 52);

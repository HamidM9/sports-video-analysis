...
int im12() {
    ...
    std::string imagePath = "Images/im12.jpg";  // Path to your image
    ...
    Scalar lowerField(60, 16, 182);
    Scalar upperField(122, 144, 240);
    Scalar lowerTeamAShirt(101, 187, 49);
    Scalar upperTeamAShirt(113, 255, 227);
    Scalar lowerTeamAShort(0, 0, 0);
    Scalar upperTeamAShort(180, 202, 41);
    Scalar lowerTeamASocks(0, 0, 0);
    Scalar upperTeamASocks(180, 202, 41);
    Scalar lowerTeamBShirt(0, 182,108);
    Scalar upperTeamBShirt(9, 255, 255);
    Scalar lowerTeamBShort(0, 0, 0);
    Scalar upperTeamBShort(180, 202, 41);
    Scalar lowerTeamBSocks(0, 0, 0);
    Scalar upperTeamBSocks(180, 202, 41);
    ...
    Canny(cannyEdgesBeforeSegment, cannyEdgesBeforeSegment, 69, 104);
    ...
    cv::imwrite(cannyEdgesAfterSegmentPath, cannyEdgesBeforeSegment);
